...
const $animationMainContainer = '[data-scroll-container]'
...
const locoScroll = new LocomotiveScroll({
  el: document.querySelector($animationMainContainer),
  smooth: true
})
 ...
 */
ScrollTrigger.scrollerProxy($animationMainContainer, {
  scrollTop (value) {
  ...
  pinType: document.querySelector($animationMainContainer).style.transform ? 'transform' : 'fixed'
})
