...
const main = async () => {
  ...
  await awatiFunction(function () {
    const spans = document.getElementsByClassName('site-container__article__title__span')
  ...
  await awatiFunction(function () {
    $('.site-container__article__title').removeClass('animate__fadeOut')
    $('.site-container__article__title').addClass('animate__fadeIn')
  }, 0)
}
