  ...
  setProfile () {
    $('#first-view').waypoint({
      handler (direction) {
        ...
        switch (direction) {
          case 'up': {
            $('.first-view__left').removeClass('animate__fadeInUp')
            $('.first-view__left').addClass('animate__fadeOutDown')
            $('.first-view__right').removeClass('animate__fadeInUp')
            $('.first-view__right').addClass('animate__fadeOutDown')
            break
          }
          case 'down': {
            $('.first-view__left').removeClass('animate__fadeOutDown')
            $('.first-view__left').addClass('animate__fadeInUp')
            $('.first-view__right').removeClass('animate__fadeOutDown')
            $('.first-view__right').addClass('animate__fadeInUp')
            break
          }
          default: {
            break
