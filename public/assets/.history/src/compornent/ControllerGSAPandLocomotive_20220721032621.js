...
export class ControllerGSAPandLocomotive {
  ...
  init () {
     ...
     */
    ScrollTrigger.scrollerProxy(this.$ANIMATION_MAIN_CONTAINER_CLASSNAME, {
      scrollTop (value) {
      ...
      pinType: document.querySelector(this.$ANIMATION_MAIN_CONTAINER_CLASSNAME).style.transform ? 'transform' : 'fixed'
    })
