...
export class ControllerGSAPandLocomotive {
  constructor () {
    ...
    this.mvScrollTrrigerConfig = {
      trigger: 'sub-visual',
      start: 'bottom bottom', // 左側が対象(trigger)の設定、 右側が画面(ブラウザ)の設定
      end: 'bottom 80%',
      /**
  ...
  doMvAnimate () {
    ...
    this.gsap.to('.main-visual__image', {
      ...
      scrollTrigger: this.mvScrollTriggerConfig
    })
  }
  ...
  doMvTextAnimate () {
    this.gsap.to('.main-visual__text', {
      ...
      scrollTrigger: mvScrollTriggerConfig
    })
  }
}
