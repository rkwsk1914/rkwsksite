...
export class ControllerGSAPandLocomotive {
    ...
    locoScroll.on('call', (func) => {
      ...
      switch (func) {
        case 'welcome':
          ...
          setTimeout(function () {
            locoScroll.start()
            $('.sub-visual').removeAttr('data-scroll-repeat')
            $('.main-visual').attr('data-scroll-call', 'welcome')
          }, 3000)
        case 'visual-back':
          locoScroll.stop()
          setTimeout(function () {
          ...
          setTimeout(function () {
            locoScroll.start()
            $('.sub-visual').attr('data-scroll-repeat')
            $('.main-visual').attr('data-scroll-call', 'visual-back')
          }, 3000)
        default:
      }
    })
  ...
  setEvent (locoScroll) {
    $('.main-visual').on('mouseover touchstart', function (e) {
  ...
  doTest () {
    this.gsap.to('.sub-visual__title', {
      duration: 3,
