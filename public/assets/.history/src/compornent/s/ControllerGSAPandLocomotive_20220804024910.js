...
import { awatiFunction } from './../common/AwatiFunction'
...
export class ControllerGSAPandLocomotive {
  ...
  init () {
    ...
    function cotrolleMvScroll () {
      console.log('cotrolleMvScroll', this)
      locoScroll.stop()
      setTimeout(function () {
    ...
    $('body').bind('touchmove', function () {
      ...
      switch (self.nowSection) {
        case 'welcome':
          ...
          cotrolleMvScroll()
        case 'works':
          if (self.intoWorks === false) {
            return
          }
          cotrolleWorkScroll()
        case 'profile':
          if (self.intoProfile === false) {
            return
          }
          cotrolleProfileScroll()
          break
