  ...
  doShowSectionProfileText () {
    this.gsap.to('#section-work', {
      ...
      onStart: async () => {
        ...
        await awatiFunction(function () {
          const picture = $('.works-list')
          $(picture).removeClass('animate__fadeOutDown')
          $(picture).addClass('animate__fadeInUp')
        }, 500)
      },
      // onUpdate: () => { console.log('onUpdate') },
      // onRepeat: () => { console.log('onRepeat') },
      ...
      scrollTrigger: {
        ...
        onLeaveBack: async (self) => {
          ...
          await awatiFunction(function () {
            const picture = $('.works-list')
            $(picture).removeClass('animate__fadeInUp')
            $(picture).addClass('animate__fadeOutDown')
          }, 500)
          await awatiFunction(function () {
            const picture = $('.works-list')
            $(picture).removeClass('animate__fadeInUp')
