  ...
  doShowSectionWorkText () {
    this.gsap.to('#section-works', {
      ...
      onStart: async () => {
        ...
        await awatiFunction(this.doFadeIn.bind(this), 0, 'index-section-works__title')
      ...
      scrollTrigger: {
        ...
        onLeaveBack: async (self) => {
          ...
          await awatiFunction(this.doFadeIn.bind(this), 0, 'index-section-works__title', true)
  ...
  doShowSectionProfileText () {
    this.gsap.to('#section-profile', {
      ...
      onStart: async () => {
        ...
        await awatiFunction(this.doFadeIn.bind(this), 0, 'index-section-profile__title')
      ...
      scrollTrigger: {
        ...
        onLeaveBack: async (self) => {
          ...
          await awatiFunction(this.doFadeIn.bind(this), 0, 'index-section-profile__title', true)
