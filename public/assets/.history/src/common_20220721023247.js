...
$(window).on('load', async () => {
  ...
  const controllerGSAPandLocomotive = await awatiFunction(new ControllerGSAPandLocomotive())
  const ph3 = await awatiFunction(controllerGSAPandLocomotive.doMvAnimate(), 0)
})
