...
$(window).on('load', async () => {
  ...
  await awatiFunction(controllerGSAPandLocomotive.init.bind(this), 1000)
  await awatiFunction(controllerGSAPandLocomotive.doMvAnimate.bind(this), 1000)
  await awatiFunction(controllerGSAPandLocomotive.doMvTextAnimate.bind(this), 0)
})
