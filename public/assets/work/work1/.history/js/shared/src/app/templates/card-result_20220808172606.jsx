        ...
        <div className="simulator-modal__card__head">
          ...
          <div className="simulator-modal__card__head__claim-area">
            <ButtonBanner
              ...
              dom={(
                <div>
                  <img className="u-sp-d-n" src="/assets/work/work1/img/p/bnr-paypay-step.png" alt="お手続きはかんたん！詳細はこちら" width="500" height="110" />
                  <img className="u-pc-d-n" src="/assets/work/work1/img/s/bnr-paypay-step.png" alt="お手続きはかんたん！詳細はこちら" width="630" height="190"/>
                </div>
              )}
