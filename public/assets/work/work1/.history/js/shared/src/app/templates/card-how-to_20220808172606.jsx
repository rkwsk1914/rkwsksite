      ...
      <div className="simulator-modal__card" id="HowTo">
        ...
        <div className="simulator-modal__card__body">
          ...
          <div className="simulator-modal__card__body__sub-text">
            <img className="simulator-modal__card__body__sub-text__img" src="/assets/work/work1/img/shared/img-paypay-lady.png" alt="lady" width="259" height="240" />
          ...
          <section className="simulator-modal__card__body__step-section">
            ...
            <img className="simulator-modal__card__body__step-section__img" src="/assets/work/work1/img/shared/pic-paypay-step-1.png" alt="STEP1" width="510" height="810" />
          </section>

          <section className="simulator-modal__card__body__step-section">
            <h4 className="simulator-modal__card__body__step-section__title">STEP2</h4>
            <p>PayPay画面の「ご利用料金に利用する」をタップ</p>
            <img className="simulator-modal__card__body__step-section__img" src="/assets/work/work1/img/shared/pic-paypay-step-2.png" alt="STEP2" width="510" height="810" />
          </section>

          <section className="simulator-modal__card__body__step-section">
            <h4 className="simulator-modal__card__body__step-section__title">STEP3</h4>
            <p>利用額を入力し「支払う」をタップ</p>
            <img className="simulator-modal__card__body__step-section__img" src="/assets/work/work1/img/shared/pic-paypay-step-3.png" alt="STEP3" width="510" height="810" />
          </section>
